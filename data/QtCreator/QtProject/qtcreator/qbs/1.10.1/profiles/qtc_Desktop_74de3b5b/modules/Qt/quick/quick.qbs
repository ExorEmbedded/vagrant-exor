...
QtModule {
    ...
    staticLibsRelease: []
    dynamicLibsDebug: []
    dynamicLibsRelease: ["/opt/qt59/lib/libQt5Qml.so.5.9.3", "/opt/qt59/lib/libQt5Gui.so.5.9.3", "/opt/qt59/lib/libQt5Network.so.5.9.3", "/opt/qt59/lib/libQt5Core.so.5.9.3", "pthread"]
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: []
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/opt/qt59/lib/libQt5Quick.so.5.9.3"
    cpp.defines: {
    ...
    cpp.includePaths: ["/opt/qt59/include", "/opt/qt59/include/QtQuick"]
    cpp.libraryPaths: ["/opt/qt59/lib", "/opt/qt59/lib"]
    property bool qmlDebugging: false
    property string qmlPath: "/opt/qt59/qml"
    property string qmlImportsPath: "/opt/qt59/imports"

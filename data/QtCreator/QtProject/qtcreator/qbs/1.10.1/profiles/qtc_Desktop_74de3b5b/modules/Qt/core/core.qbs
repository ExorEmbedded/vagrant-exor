...
Module {
    ...
    property path docPath: "/opt/qt59/doc"
    ...
    property string libFilePathRelease: "/opt/qt59/lib/libQt5Core.so.5.9.3"
    ...
    cpp.includePaths: {
        var paths = ["/opt/qt59/include", "/opt/qt59/include/QtCore"];
